...
const Sankey = lazy(() => import('@/app/(admin)/charts/sankey/page'))
const TangledTree = lazy(() => import('@/app/(admin)/charts/tangled-tree/page'))
const DivergingBar = lazy(() => import('@/app/(admin)/charts/diverging-bar/page'))
const IndentedTree = lazy(() => import('@/app/(admin)/charts/indented-tree/page'))
...
const chartsNMapsRoutes: RoutesProps[] = [
  ...
  {
    name: 'Tangled Tree',
    path: '/charts/tangled-tree',
    element: <TangledTree />,
  },
  {
    name: 'Diverging Bar',
    path: '/charts/diverging-bar',
    element: <DivergingBar />,
  },
  {
    name: 'Indented Tree',
    path: '/charts/indented-tree',
    element: <IndentedTree />,
  },
  {
    name: 'Google',
    path: '/maps/google',
